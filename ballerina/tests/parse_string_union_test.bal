...
function testParseStringUnionTypes1() {
    A11|error a11 = xmldata:parseString(x1);
    test:assertEquals(a11, {"#content": "42"});

    A12|error a12 = xmldata:parseString(x1);
    ...
    A14|error a14 = xmldata:parseString(x1);
    test:assertEquals(a14, {"#content": 42});
}

string x2 = string `<A a1="2024" a2="3.14">Sample Text</A>`;
...
function testParseStringUnionTypes2() {
    A21|error a21 = xmldata:parseString(x2);
    test:assertEquals(a21, {"#content":"Sample Text","a1":2024});

    A22|error a22 = xmldata:parseString(x2);
...
// custom bug
    // A31|error a31 = xmldata:parseString(x3);
    // test:assertEquals(a31, {"B":"100"});

    A31P2|error a31p2 = xmldata:parseString(x3);
    test:assertEquals(a31p2, {"b":"100"});

    A32|error a32 = xmldata:parseString(x3);
    test:assertEquals(a32, {"b":{"#content":100}});

    A33|error a33 = xmldata:parseString(x3);
    test:assertEquals(a33, {"B":100});

    A34|error a34 = xmldata:parseString(x3);
    test:assertEquals(a34, {"B":[{"#content":100}]});

// custom bug
    // A35|error a35 = xmldata:parseString(x3);
    // test:assertEquals(a35, {"B":{"#content":"100"}});
}

string x4 = string `<A><B b1="99" b2="45.67" b3="1">Nested Content</B></A>`;
...
function testParseStringUnionTypes5() {
    ...
    // A51|error a51 = xmldata:parseString(x5);
    // test:assertEquals(a51, {"B":[{"#content":123},{"#content":456}]});

    A52|error a52 = xmldata:parseString(x5);
    test:assertEquals(a52, {"B":[123,456]});

    // //bug https://github.com/ballerina-platform/ballerina-library/issues/6907
    // A53|error a53 = xmldata:parseString(x5);
    // test:assertEquals(a53, {);

    // //bug https://github.com/ballerina-platform/ballerina-library/issues/6907
    // A54|error a54 = xmldata:parseString(x5);
    // test:assertEquals(a54, {});

    // // bug #6
    // A55|error a55 = xmldata:parseString(x5);
    // test:assertEquals(a55, {"B":[123,456]});

    A56|error a56 = xmldata:parseString(x5);
    test:assertEquals(a56, {"B":[{"#content":123},{"#content":456}]});

    A57|error a57 = xmldata:parseString(x5);
    test:assertEquals(a57, {"B":[{"#content":123},{"#content":456}]});

    // //bug https://github.com/ballerina-platform/ballerina-library/issues/6907
    // A58|error a58 = xmldata:parseString(x5);
    // test:assertEquals(a58, {"B":[{"#content":123},{"#content":456}]});
}

string x6 = string `<A><B b1="car" b2="red">Toyota</B><C c1="bike" c2="blue">Yamaha</C></A>`;
...
function testParseStringUnionTypes6() {
    A61|error a61 = xmldata:parseString(x6);
    test:assertEquals(a61, {"C":"Yamaha","B":[{"#content":"Toyota"}]});

    A62|error a62 = xmldata:parseString(x6);
    test:assertEquals(a62, {"B":"Toyota","C":"Yamaha"});

    A63|error a63 = xmldata:parseString(x6);
    test:assertEquals(a63, {"B":[{"#content":"Toyota"}],"C":[{"#content":"Yamaha"}]});

    A64|error a64 = xmldata:parseString(x6);
    test:assertEquals(a64, {"B":[{"#content":"Toyota"}]});
}

string x7 = string `<A><B b1="solid" b2="red">Brick</B><B b1="liquid" b2="blue">Water</B><C c1="gas" c2="transparent">Air</C></A>`;
...
function testParseStringUnionTypes8() {
    A81|error a81 = xmldata:parseString(x8);
    test:assertEquals(a81, {"B":[{"C":[{"#content":"First"}]},{"C":[{"#content":"Second"},{"#content":"Third"}]},{}]});

    A81Part2|error a81p2 = xmldata:parseString(x8);
...
string x9 = string `<A a1="level1" a2="root">
...
string x10 = string `<A xmlns:ns1="http://example.com/ns1" ns1:a1="outer">
                <ns1:B ns1:b1="middle">
...
function testParseStringUnionTypes11() {
    A111|error a111 = xmldata:parseString(x11);
    ...
    A112|error a112 = xmldata:parseString(x11);
...
string x12 = string `<ns1:A xmlns:ns1="http://example.com/ns1" xmlns:ns2="http://example.com/ns2" ns1:a1="outer">
                <ns2:B ns2:b1="middle">
...
function testParseStringUnionTypes12() {
    A121|error a121 = xmldata:parseString(x12);
    ...
    A122|error a122 = xmldata:parseString(x12);
