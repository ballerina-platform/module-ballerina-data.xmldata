...
function testXsdSequenceWithXmlValue() returns error? {
    ...
    test:assertTrue((<Error>v).message().includes("Element salary is not in the correct order in seq_XSDSequenceRecordWithXmlValue"), msg = (<Error>v).message());

    xmlValue = xml `<Root><age>13</age></Root>`;
    v = parseAsType(xmlValue);
    test:assertTrue(v is Error);
    test:assertTrue((<Error>v).message().includes("Element salary not found in seq_XSDSequenceRecordWithXmlValue"), msg = (<Error>v).message());
    ...
    test:assertTrue((<Error>v).message().includes("required field 'seq_XSDSequenceRecordWithXmlValue' not present in XML"), msg = (<Error>v).message());
    ...
    // xmlValue = xml `<Root><salary><age>13</age></salary></Root>`;
    // v = parseAsType(xmlValue);
    // test:assertTrue(v is Error);
...
function testXsdSequenceWithXmlValueP2() returns error? {
    ...
    v = parseAsType(xmlValue);
    test:assertTrue(v is Error);
    test:assertTrue((<Error>v).message().includes("Element salary, name not found in seq_XSDSequenceRecordWithXmlValueP2"), msg = (<Error>v).message());
}
...
function testXsdSequenceWithXmlValue4() returns error? {
    ...
    xmlValue = xml `<Root><age>13</age><salary>11.1</salary><num><n><n>3</n></n></num></Root>`;
    v2 = parseAsType(xmlValue);
    test:assertEquals(v2, {seq_XSDSequenceRecordWithXmlValue4: {age: 13, salary: 11.1}, num: {n: {n: 3}}});
    test:assertEquals((check v2).seq_XSDSequenceRecordWithXmlValue4.age, 13);
    test:assertEquals((check v2).seq_XSDSequenceRecordWithXmlValue4.salary, 11.1);
...
function testXsdSequenceWithXmlValue7() returns error? {
    ...
    test:assertEquals((check v2).seq_XSDSequenceRecordWithXmlValue7_2.status, "success");
}
...
function testXsdSequenceWithXmlValue8() returns error? {
    ...
    test:assertEquals(v2, {'check: 2, test: {seq_XSDSequenceRecordWithXmlValue8_1: {age: 13, salary: 11.1}, seq_XSDSequenceRecordWithXmlValue8_2: {name: "SD", status: "success"}}});
...
function testXsdSequenceWithXmlValue13() returns error? {
    ...
    test:assertTrue((<Error>v2).message().includes("Element field5 is not in the correct order in seq_XSDSequenceRecordWithXmlValue13_2"), msg = (<Error>v2).message());
}
